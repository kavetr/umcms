    ...
    <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                  <div class="item active">
	                ...
	                <p>
	                   <a href="http://www.umcms.net/news/index_id_100001.html" class="btn btn-primary btn-large" >下载UMcms</a>
	                </p>
                  ...
                  <div class="item">
	                ...
	                <p>将复杂回归简洁，把简单变得精致</p>
	                <p>
	                   <a href="help/index.html" class="btn btn-success btn-large" id="start-intro">UMms入门指南</a>
	                </p>
	                <ul class="masthead-links">
	                    <li><a href="#" target="_blank">模板</a></li>
	                    <li><a href="#">案例</a></li>
    ...
    <div class="span6">
        <div class="tabbable tabs-left well">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="lA">
                  <p>UMcms是一款高效,灵活,实用,免费的企业建站系统,基于PHP和mysql技术,采用MVC三层架构，让您拥有更加专业的企业建站和企业网站制作服务。</p>
                </div>
       ...
       <button class="btn btn-small btn-warning popo"  data-toggle="popover" data-placement="bottom" data-content="遵循BSD开源协议，不对用户做任何功能限制，保证用户二次商业开发使用！" title="免费" type="button"><h3>免&nbsp;&nbsp;费</h3></button>
                ...
                <div class="tab-pane" id="lD">
                  <p>本站为UMcms的默认演示模板，给用户展示各种UI使用方法。用户可在模板中自行修改调整。甚至自行设计新模板。</p>
                </div>
              </div>
            </div>
       </div>
