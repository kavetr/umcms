...
<div class="footer">
    <div class="container">
      <div class="row-fluid">
        <div class="span3 muted text-center"><h1>UMCMS</h1></div>
        <div class="span9">
             ...
             <p class="muted">Copyright © 2012-2019 UMcms.net. All rights reserved.Powered By <a class="Notice" data-toggle="tooltip" title="免费版必须保留此链接" href="http://www.umcms.net">UMcms</a></p>
