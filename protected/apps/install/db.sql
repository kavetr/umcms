...
Source Database       : umcms

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2016-09-19 08:39:48
*/
...
-- Records of um_admin
-- ----------------------------
INSERT INTO `um_admin` VALUES ('1', '1', 'admin', 'UM', '168a73655bfecefdb15b14984dd2ad60', '1456378504', 'unknown', '0', '', '');

-- ----------------------------
-- Table structure for um_collectrules
-- ----------------------------
DROP TABLE IF EXISTS `um_collectrules`;
CREATE TABLE `um_collectrules` (
...
-- ----------------------------
-- Records of um_collectrules
-- ----------------------------
INSERT INTO `um_collectrules` VALUES ('2', '演示站采集测试', 'http://www.oschina.net/code/list?lang=&amp;catalog=&amp;show=time&amp;sort=&amp;p=*', '', 'iframe,object,script,html,body', ',000000,100001,100005,100016', '', '1', '0', '.code_list li', '.code_title a:eq(0)', 'admin', '.Body', '.QTitle h1', '', '.ShowUserOutline img', '', '', '.Content', 'default/column/content', 'news_content', '0', '0', '1,100', '1', '原创', '2013-11-15 11:10:10,2014-11-15 11:10:10', '', '', '', '', '0');

-- ----------------------------
-- Table structure for um_extend
-- ----------------------------
DROP TABLE IF EXISTS `um_extend`;
CREATE TABLE `um_extend` (
...
-- ----------------------------
-- Records of um_extend
-- ----------------------------
INSERT INTO `um_extend` VALUES ('7', '0', 'extend_conment', '1', '', '内容评论', '0', '0');
INSERT INTO `um_extend` VALUES ('8', '7', 'aid', '1', '0', '资讯id', '0', '2');
INSERT INTO `um_extend` VALUES ('9', '7', 'comby', '1', '', '评论者', '0', '4');
INSERT INTO `um_extend` VALUES ('10', '7', 'comcontent', '3', '', '评论内容', '0', '3');
INSERT INTO `um_extend` VALUES ('11', '7', 'type', '1', '0', '类型', '0', '1');
INSERT INTO `um_extend` VALUES ('12', '0', 'extend_guestbook', '1', '', '留言本', '0', '0');
INSERT INTO `um_extend` VALUES ('13', '12', 'tname', '1', '', '姓名', '0', '0');
INSERT INTO `um_extend` VALUES ('14', '12', 'tel', '1', '', '电话', '0', '0');
INSERT INTO `um_extend` VALUES ('15', '12', 'qq', '1', '', 'QQ', '0', '0');
INSERT INTO `um_extend` VALUES ('16', '12', 'content', '3', '', '留言内容', '0', '0');
INSERT INTO `um_extend` VALUES ('17', '12', 'reply', '2', '', '回复内容', '0', '0');
INSERT INTO `um_extend` VALUES ('18', '0', 'extend_product', '0', '', '产品信息', '0', '0');
INSERT INTO `um_extend` VALUES ('19', '18', 'pinpai', '1', '', '品牌', '0', '0');
INSERT INTO `um_extend` VALUES ('20', '18', 'caizhi', '1', '', '材质', '0', '0');
INSERT INTO `um_extend` VALUES ('21', '18', 'chandi', '1', '', '产地', '0', '0');
INSERT INTO `um_extend` VALUES ('22', '18', 'jiage', '1', '0', '价格', '0', '0');
INSERT INTO `um_extend` VALUES ('23', '7', 'title', '2', '', '标题', '0', '5');
INSERT INTO `um_extend` VALUES ('24', '7', 'sortname', '1', '', '栏目名称', '0', '6');
INSERT INTO `um_extend` VALUES ('25', '7', 'backcontent', '2', '', '评论回复', '0', '0');

-- ----------------------------
-- Table structure for um_extend_conment
-- ----------------------------
DROP TABLE IF EXISTS `um_extend_conment`;
CREATE TABLE `um_extend_conment` (
...
-- ----------------------------
-- Records of um_extend_conment
-- ----------------------------

-- ----------------------------
-- Table structure for um_extend_guestbook
-- ----------------------------
DROP TABLE IF EXISTS `um_extend_guestbook`;
CREATE TABLE `um_extend_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `addtime` int(11) NOT NULL,
  `ip` varchar(16) NOT NULL,
  `ispass` tinyint(1) NOT NULL,
...
-- ----------------------------
-- Records of um_extend_guestbook
-- ----------------------------
INSERT INTO `um_extend_guestbook` VALUES ('1', '1439525302', 'unknown', '1', '李某某', '13865748765', '404133748', '测试内容', '测试回复');

-- ----------------------------
-- Table structure for um_extend_product
-- ----------------------------
DROP TABLE IF EXISTS `um_extend_product`;
CREATE TABLE `um_extend_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of um_extend_product
-- ----------------------------
INSERT INTO `um_extend_product` VALUES ('1', '', '', '', '');
INSERT INTO `um_extend_product` VALUES ('2', '', '', '', '');
INSERT INTO `um_extend_product` VALUES ('3', '山水之间', '陶瓷', '景德镇市茶餐具', '99');
INSERT INTO `um_extend_product` VALUES ('4', '宜兴龙纹', '紫砂', '江苏宜兴', '2000');
INSERT INTO `um_extend_product` VALUES ('5', 'housing', '陶瓷', '英国', '30');
INSERT INTO `um_extend_product` VALUES ('6', 'Zassenhaus', '原木，钢', '德国', '300');

-- ----------------------------
-- Table structure for um_fragment
-- ----------------------------
DROP TABLE IF EXISTS `um_fragment`;
CREATE TABLE `um_fragment` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of um_fragment
-- ----------------------------
INSERT INTO `um_fragment` VALUES ('1', '公告信息', 'notice', '本站为UMcms的默认演示模板，UMcms是一款基于PHP+MYSQL构建的高效网站管理系统。 后台地址请在网址后面加上/index.php?r=admin进入。 后台的用户名:admin;密码:123456，请进入后修改默认密码。');
...
-- Records of um_group
-- ----------------------------
INSERT INTO `um_group` VALUES ('1', '超级管理员', '-1');
INSERT INTO `um_group` VALUES ('2', '网站编辑', '283,1,228,10,11,12,13,14,15,16,157,158,174,268,288,317,22,23,24,25,26,27,150,151,152,153,154,155,156,159,160,269,289,290,291,318,188,189,190,191,192,229,238,239,240,241,243,244,308,309,310,311,312,313');

-- ----------------------------
-- Table structure for um_link
-- ----------------------------
...
-- Records of um_link
-- ----------------------------
INSERT INTO `um_link` VALUES ('1', 'banner', '100', '首页banner1', '#', '1435642012.png', '', '', '1');
INSERT INTO `um_link` VALUES ('2', 'banner', '100', '首页banner2', '#', '1435642060.png', '', '', '1');
INSERT INTO `um_link` VALUES ('3', 'friends', '100', 'UMcms', 'http://www.umcms.net', '1435642319.png', '', 'UMcms是一款高效,灵活,实用,免费的企业建站系统', '1');

-- ----------------------------
-- Table structure for um_members
-- ----------------------------
DROP TABLE IF EXISTS `um_members`;
CREATE TABLE `um_members` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of um_members
-- ----------------------------

-- ----------------------------
-- Table structure for um_member_group
-- ----------------------------
DROP TABLE IF EXISTS `um_member_group`;
CREATE TABLE `um_member_group` (
...
-- ----------------------------
-- Records of um_member_group
-- ----------------------------
INSERT INTO `um_member_group` VALUES ('1', '未登录', 'member/infor|member/order|member/news|member/photo');
INSERT INTO `um_member_group` VALUES ('2', '普通会员', '');

-- ----------------------------
-- Table structure for um_method
-- ----------------------------
DROP TABLE IF EXISTS `um_method`;
CREATE TABLE `um_method` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of um_method
-- ----------------------------
INSERT INTO `um_method` VALUES ('1', '1', '0', 'admin', '后台登陆管理', '1');
INSERT INTO `um_method` VALUES ('2', '1', '1', 'index', '管理员管理', '1');
INSERT INTO `um_method` VALUES ('4', '1', '1', 'admindel', '管理员删除', '0');
INSERT INTO `um_method` VALUES ('5', '1', '1', 'adminedit', '管理员编辑', '0');
INSERT INTO `um_method` VALUES ('6', '1', '1', 'adminlock', '管理员锁定', '0');
INSERT INTO `um_method` VALUES ('7', '1', '1', 'group', '权限管理', '1');
INSERT INTO `um_method` VALUES ('8', '1', '1', 'groupedit', '管理组编辑', '0');
INSERT INTO `um_method` VALUES ('9', '1', '1', 'groupdel', '管理组删除', '0');
INSERT INTO `um_method` VALUES ('10', '10', '0', 'news', '资讯管理', '1');
INSERT INTO `um_method` VALUES ('11', '10', '10', 'index', '已有资讯', '1');
INSERT INTO `um_method` VALUES ('12', '10', '10', 'add', '添加资讯', '1');
INSERT INTO `um_method` VALUES ('13', '10', '10', 'edit', '资讯编辑', '0');
INSERT INTO `um_method` VALUES ('14', '10', '10', 'del', '资讯删除', '0');
INSERT INTO `um_method` VALUES ('15', '10', '10', 'lock', '资讯锁定', '0');
INSERT INTO `um_method` VALUES ('16', '10', '10', 'recmd', '资讯推荐', '0');
INSERT INTO `um_method` VALUES ('17', '17', '0', 'dbback', '数据库管理', '1');
INSERT INTO `um_method` VALUES ('18', '17', '17', 'index', '数据库备份', '1');
INSERT INTO `um_method` VALUES ('19', '17', '17', 'recover', '备份恢复', '0');
INSERT INTO `um_method` VALUES ('20', '17', '17', 'detail', '备份详细', '0');
INSERT INTO `um_method` VALUES ('21', '17', '17', 'del', '备份删除', '0');
INSERT INTO `um_method` VALUES ('22', '22', '0', 'index', '后台面板', '0');
INSERT INTO `um_method` VALUES ('23', '22', '22', 'index', '后台首页', '0');
INSERT INTO `um_method` VALUES ('24', '22', '22', 'login', '登陆', '0');
INSERT INTO `um_method` VALUES ('25', '22', '22', 'logout', '退出登陆', '0');
INSERT INTO `um_method` VALUES ('26', '22', '22', 'verify', '验证码', '0');
INSERT INTO `um_method` VALUES ('27', '22', '22', 'welcome', '服务器环境', '0');
INSERT INTO `um_method` VALUES ('28', '28', '0', 'set', '全局设置', '1');
INSERT INTO `um_method` VALUES ('29', '28', '28', 'index', '网站设置', '1');
INSERT INTO `um_method` VALUES ('30', '30', '0', 'sort', '分类管理', '1');
INSERT INTO `um_method` VALUES ('31', '30', '30', 'index', '栏目列表', '1');
INSERT INTO `um_method` VALUES ('32', '30', '30', 'edit', '分类编辑', '0');
INSERT INTO `um_method` VALUES ('33', '30', '30', 'del', '分类删除', '0');
INSERT INTO `um_method` VALUES ('160', '150', '150', 'delpic', '图集单张图删除', '0');
INSERT INTO `um_method` VALUES ('277', '0', '0', 'appmanage', '应用管理', '1');
INSERT INTO `um_method` VALUES ('85', '28', '28', 'menuname', '后台功能', '1');
INSERT INTO `um_method` VALUES ('159', '150', '150', 'images_upload', '图片批量上传', '0');
INSERT INTO `um_method` VALUES ('158', '10', '10', 'FileManagerJson', '编辑器上传管理', '0');
INSERT INTO `um_method` VALUES ('157', '10', '10', 'UploadJson', '编辑器上传', '0');
INSERT INTO `um_method` VALUES ('150', '150', '0', 'photo', '图集管理', '1');
INSERT INTO `um_method` VALUES ('151', '150', '150', 'index', '已有图集', '1');
INSERT INTO `um_method` VALUES ('152', '150', '150', 'add', '添加图集', '1');
INSERT INTO `um_method` VALUES ('153', '150', '150', 'edit', '图集编辑', '0');
INSERT INTO `um_method` VALUES ('154', '150', '150', 'del', '图集删除', '0');
INSERT INTO `um_method` VALUES ('155', '150', '150', 'lock', '图集锁定', '0');
INSERT INTO `um_method` VALUES ('156', '150', '150', 'recmd', '图集推荐', '0');
INSERT INTO `um_method` VALUES ('174', '10', '10', 'cutcover', '封面图剪切', '0');
INSERT INTO `um_method` VALUES ('236', '30', '30', 'PageUploadJson', '单页上传', '0');
INSERT INTO `um_method` VALUES ('235', '30', '30', 'pageedit', '单页编辑', '0');
INSERT INTO `um_method` VALUES ('234', '30', '30', 'pageadd', '添加单页栏目', '0');
INSERT INTO `um_method` VALUES ('233', '30', '30', 'photoedit', '图集栏目编辑', '0');
INSERT INTO `um_method` VALUES ('232', '30', '30', 'photoadd', '添加图集栏目', '0');
INSERT INTO `um_method` VALUES ('231', '30', '30', 'newsedit', '文章栏目编辑', '0');
INSERT INTO `um_method` VALUES ('230', '30', '30', 'newsadd', '添加文章栏目', '0');
INSERT INTO `um_method` VALUES ('182', '28', '28', 'clear', '网站缓存', '1');
INSERT INTO `um_method` VALUES ('188', '188', '0', 'link', '友情链接', '1');
INSERT INTO `um_method` VALUES ('189', '188', '188', 'index', '链接列表', '1');
INSERT INTO `um_method` VALUES ('190', '188', '188', 'add', '添加链接', '1');
INSERT INTO `um_method` VALUES ('191', '188', '188', 'edit', '链接编辑', '0');
INSERT INTO `um_method` VALUES ('192', '188', '188', 'del', '链接删除', '0');
INSERT INTO `um_method` VALUES ('228', '1', '1', 'adminnow', '账户管理', '1');
INSERT INTO `um_method` VALUES ('229', '188', '188', 'lock', '锁定', '0');
INSERT INTO `um_method` VALUES ('237', '30', '30', 'PageFileManagerJson', '单页上传管理', '0');
INSERT INTO `um_method` VALUES ('238', '238', '0', 'fragment', '碎片管理', '1');
INSERT INTO `um_method` VALUES ('239', '238', '238', 'index', '碎片列表', '1');
INSERT INTO `um_method` VALUES ('240', '238', '238', 'add', '碎片添加', '1');
INSERT INTO `um_method` VALUES ('241', '238', '238', 'edit', '碎片编辑', '0');
INSERT INTO `um_method` VALUES ('242', '238', '238', 'del', '碎片删除', '0');
INSERT INTO `um_method` VALUES ('243', '238', '238', 'UploadJson', '编辑器上传', '0');
INSERT INTO `um_method` VALUES ('244', '238', '238', 'FileManagerJson', '编辑器上传管理', '0');
INSERT INTO `um_method` VALUES ('245', '28', '28', 'tpchange', '前台模板', '1');
INSERT INTO `um_method` VALUES ('251', '30', '30', 'pluginadd', '添加应用栏目', '0');
INSERT INTO `um_method` VALUES ('252', '30', '30', 'pluginedit', '应用栏目编辑', '0');
INSERT INTO `um_method` VALUES ('258', '258', '0', 'extendfield', '自定义表', '1');
INSERT INTO `um_method` VALUES ('259', '258', '258', 'index', '自定义表列表', '1');
INSERT INTO `um_method` VALUES ('260', '258', '258', 'tableadd', '添加自定义表', '1');
INSERT INTO `um_method` VALUES ('261', '258', '258', 'tableedit', '拓展表编辑', '0');
INSERT INTO `um_method` VALUES ('262', '258', '258', 'tabledel', '拓展表删除', '0');
INSERT INTO `um_method` VALUES ('263', '258', '258', 'fieldlist', '字段列表', '0');
INSERT INTO `um_method` VALUES ('264', '258', '258', 'fieldadd', '添加字段', '0');
INSERT INTO `um_method` VALUES ('265', '258', '258', 'fieldedit', '编辑字段', '0');
INSERT INTO `um_method` VALUES ('266', '258', '258', 'fielddel', '字段删除', '0');
INSERT INTO `um_method` VALUES ('267', '258', '258', 'file', '文件上传', '0');
INSERT INTO `um_method` VALUES ('268', '10', '10', 'ex_field', '字段拓展', '0');
INSERT INTO `um_method` VALUES ('269', '150', '150', 'ex_field', '字段拓展', '0');
INSERT INTO `um_method` VALUES ('270', '30', '30', 'linkadd', '添加自定义栏目', '0');
INSERT INTO `um_method` VALUES ('271', '30', '30', 'linkedit', '自定义栏目编辑', '0');
INSERT INTO `um_method` VALUES ('283', '0', '0', 'member', '会员管理(应用)', '1');
INSERT INTO `um_method` VALUES ('288', '10', '10', 'colchange', '资讯转移栏目', '0');
INSERT INTO `um_method` VALUES ('289', '150', '150', 'colchange', '图集转移栏目', '0');
INSERT INTO `um_method` VALUES ('290', '150', '150', 'UploadJson', '图集编辑器上传', '0');
INSERT INTO `um_method` VALUES ('291', '150', '150', 'FileManagerJson', '图集编辑器上传管理', '0');
INSERT INTO `um_method` VALUES ('292', '28', '28', 'tplist', '模板文件列表', '0');
INSERT INTO `um_method` VALUES ('293', '28', '28', 'tpadd', '模板文件添加', '0');
INSERT INTO `um_method` VALUES ('294', '28', '28', 'tpedit', '模板文件编辑', '0');
INSERT INTO `um_method` VALUES ('295', '28', '28', 'tpdel', '删除模板文件', '0');
INSERT INTO `um_method` VALUES ('296', '28', '28', 'tpgetcode', '获取模板内容', '0');
INSERT INTO `um_method` VALUES ('297', '258', '258', 'meslist', '自定义表信息', '0');
INSERT INTO `um_method` VALUES ('298', '258', '258', 'mesedit', '自定义表信息添加', '0');
INSERT INTO `um_method` VALUES ('299', '258', '258', 'mesedit', '自定义表信息编辑', '0');
INSERT INTO `um_method` VALUES ('300', '258', '258', 'mesdel', '自定义表信息删除', '0');
INSERT INTO `um_method` VALUES ('331', '258', '258', 'meslock', '自定义表信息审核', '0');
INSERT INTO `um_method` VALUES ('301', '30', '30', 'add', '添加栏目', '1');
INSERT INTO `um_method` VALUES ('302', '30', '30', 'extendadd', '添加表单栏目', '0');
INSERT INTO `um_method` VALUES ('303', '30', '30', 'extendedit', '表单栏目编辑', '0');
INSERT INTO `um_method` VALUES ('304', '30', '30', 'placelist', '内容定位列表', '1');
INSERT INTO `um_method` VALUES ('305', '30', '30', 'placeadd', '添加内容定位', '1');
INSERT INTO `um_method` VALUES ('306', '30', '30', 'placeedit', '定位编辑', '0');
INSERT INTO `um_method` VALUES ('307', '30', '30', 'placedel', '定位删除', '0');
INSERT INTO `um_method` VALUES ('308', '308', '0', 'tags', 'TAG标签', '1');
INSERT INTO `um_method` VALUES ('309', '308', '308', 'index', '标签列表', '1');
INSERT INTO `um_method` VALUES ('310', '308', '308', 'del', '删除标签', '0');
INSERT INTO `um_method` VALUES ('311', '308', '308', 'hits', '编辑点击量', '0');
INSERT INTO `um_method` VALUES ('312', '308', '308', 'add', '生成标签', '1');
INSERT INTO `um_method` VALUES ('313', '308', '308', 'mesup', '文档数量更新', '0');
INSERT INTO `um_method` VALUES ('314', '314', '0', 'files', '附件管理', '1');
INSERT INTO `um_method` VALUES ('315', '314', '314', 'index', '上传文件管理', '1');
INSERT INTO `um_method` VALUES ('316', '314', '314', 'del', '删除文件', '0');
INSERT INTO `um_method` VALUES ('317', '10', '10', 'orderchange', '列表ajax排序', '0');
INSERT INTO `um_method` VALUES ('318', '150', '150', 'orderchange', '列表ajax排序', '0');
INSERT INTO `um_method` VALUES ('319', '30', '30', 'orderchange', '列表ajax排序', '0');
INSERT INTO `um_method` VALUES ('320', '17', '17', 'sqlrun', 'SQL执行', '1');
INSERT INTO `um_method` VALUES ('321', '30', '30', 'cutcover', '栏目封面剪切', '0');
INSERT INTO `um_method` VALUES ('322', '238', '238', 'saveimage', '图片本地化', '0');
INSERT INTO `um_method` VALUES ('323', '10', '10', 'saveimage', '图片本地化', '0');
INSERT INTO `um_method` VALUES ('324', '10', '10', 'delcover', '删除封面图', '0');
INSERT INTO `um_method` VALUES ('325', '30', '30', 'delcover', '删除封面图', '0');
INSERT INTO `um_method` VALUES ('326', '30', '30', 'pagesaveimage', '图片本地化', '0');
INSERT INTO `um_method` VALUES ('328', '30', '30', 'sortsmove', '栏目批量移动', '0');
INSERT INTO `um_method` VALUES ('329', '30', '30', 'sortsedit', '栏目批量编辑', '0');
INSERT INTO `um_method` VALUES ('330', '30', '30', 'ifmenu', '栏目设置隐藏', '0');
INSERT INTO `um_method` VALUES ('332', '258', '258', 'mesadd', '自定义表添加信息', '0');
INSERT INTO `um_method` VALUES ('333', '308', '308', 'hadd', '手动添加标签', '0');
INSERT INTO `um_method` VALUES ('334', '308', '308', 'edit', '标签编辑', '0');
INSERT INTO `um_method` VALUES ('335', '335', '0', 'seo', 'SEO优化', '1');
INSERT INTO `um_method` VALUES ('336', '335', '335', 'sitemap', 'SiteMap', '1');

-- ----------------------------
-- Table structure for um_news
-- ----------------------------
DROP TABLE IF EXISTS `um_news`;
CREATE TABLE `um_news` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of um_orders
-- ----------------------------

-- ----------------------------
-- Table structure for um_order_detail
-- ----------------------------
DROP TABLE IF EXISTS `um_order_detail`;
CREATE TABLE `um_order_detail` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of um_order_detail
-- ----------------------------

-- ----------------------------
-- Table structure for um_page
-- ----------------------------
DROP TABLE IF EXISTS `um_page`;
...
-- Records of um_page
-- ----------------------------
INSERT INTO `um_page` VALUES ('1', ',000000,100001', '<span style=\"color:#333333;font-family:\'Microsoft YaHei\', simsun, \'Helvetica Neue\', Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-indent:28px;white-space:normal;background-color:#FFFFFF;\">UMcms是一款高效,灵活,实用,免费的企业建站系统,基于PHP和mysql技术,让您拥有更加专业的企业建站和企业网站制作服务。采用三级缓存：数据库缓存、模板缓存、静态缓存，可使网站数据达到百万级负载.采用功能与显示分离设计，灵活的标签库和任意拓展的插件机制，让您随心所欲，将DIY进行到底。拥有建站各种实用功能，摒弃各种复杂繁琐的功能操作。卓越的用户体验，让您使用起来方便明了。遵循BSD开源协议，不对用户做任何功能限制，保证用户二次商业开发使用。</span>', '2015-06-30 12:56:53');

-- ----------------------------
-- Table structure for um_photo
-- ----------------------------
DROP TABLE IF EXISTS `um_photo`;
CREATE TABLE `um_photo` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `sort` varchar(350) NOT NULL COMMENT '类别',
  `exsort` varchar(350) NOT NULL,
  `account` char(15) NOT NULL COMMENT '发布者账户',
...
-- Records of um_place
-- ----------------------------
INSERT INTO `um_place` VALUES ('101', '首页推荐', '100');

-- ----------------------------
-- Table structure for um_sort
-- ----------------------------
DROP TABLE IF EXISTS `um_sort`;
CREATE TABLE `um_sort` (
...
-- Records of um_sort
-- ----------------------------
INSERT INTO `um_sort` VALUES ('100001', '3', ',000000', '系统介绍', 'aboutus', '0', '0', '20150630/thumb_1435644326.png', '1', '100', '1', 'page/index', 'page_index', 'umcms,简洁,简单,快捷', 'UMcms是一款高效,灵活,实用,免费的企业建站系统,基于PHP和mysql技术,让您拥有更加专业的企业建站和企业网站制作服务。采用三级缓存：数据库缓存、模板缓存、静态缓存，可使网站数据达到百万级负载.采用功能与显示分离设计，灵活的标签库和任意拓展的插件机制，让您随心所欲，将DIY进行到底。拥有建站各种实用功能，摒弃各种复杂繁琐的功能操作。卓越的用户体验，让您使用起来方便明了。遵循BSD开源协议，不对用户做任何功能限制，保证用户二次商业开发使用。', '', '0');
INSERT INTO `um_sort` VALUES ('100002', '2', ',000000', '模板演示', 'demoshow', '340', '340', '', '1', '100', '1', 'photo/index', 'photo_index,photo_content', 'umcms,模板,演示', 'umcms模板演示', '10', '0');
INSERT INTO `um_sort` VALUES ('100003', '1', ',000000', '建站知识', 'knowledge', '225', '76', '', '1', '100', '1', 'news/index', 'news_index,news_content', '网站建设,基本常识', '网站建设常识', '10', '0');
INSERT INTO `um_sort` VALUES ('100004', '1', ',000000,100003', '后台技术', 'background', '225', '76', '', '2', '100', '1', 'news/index', 'news_indexs,news_content', '网站,后台,知识', '网站后台知识', '10', '0');
INSERT INTO `um_sort` VALUES ('100005', '1', ',000000,100003', '前端技术', 'frontend', '225', '76', '', '2', '100', '1', 'news/index', 'news_index,news_content', '网站,前端,概括,介绍', '网站前端概括介绍', '10', '0');
INSERT INTO `um_sort` VALUES ('100006', '1', ',000000,100003', '推广知识', 'promotion', '225', '76', '', '2', '100', '1', 'news/index', 'news_indexs,news_content', '网站,推广,知识', '网站推广知识', '10', '0');
INSERT INTO `um_sort` VALUES ('100007', '1', ',000000,100003,100005', '前端基础', 'frontbase', '225', '76', '', '3', '100', '1', 'news/index', 'news_index,news_content', '网站,前端,基础,介绍', '网站前端基础介绍', '10', '0');
INSERT INTO `um_sort` VALUES ('100008', '1', ',000000,100003,100005', '前端框架', 'frontframe', '225', '76', '', '3', '100', '1', 'news/index', 'news_index,news_content', '前端,框架,介绍', '主流和非主流的前端框架介绍', '10', '0');
INSERT INTO `um_sort` VALUES ('100009', '1', ',000000,100003,100005,100007', 'JavaScript', 'javascript', '225', '76', '', '4', '100', '1', 'news/index', 'news_index,news_content', 'JavaScript,入门,介绍', 'JavaScript入门介绍', '10', '0');
INSERT INTO `um_sort` VALUES ('100010', '1', ',000000,100003,100005,100007', 'Css', 'css', '225', '76', '', '4', '100', '1', 'news/index', 'news_index,news_content', 'Css,入门,介绍', 'Css入门介绍', '10', '0');
INSERT INTO `um_sort` VALUES ('100011', '2', ',000000', '产品展示', 'products', '271', '271', '', '1', '100', '1', 'photo/index', 'photo_indexp,photo_pcontent', '产品,演示', '产品展示', '10', '18');
INSERT INTO `um_sort` VALUES ('100012', '6', ',000000', '留言本', 'guestbook', '0', '0', '', '1', '100', '1', 'extend/index', 'extend_guestbook', '在线留言', '在线留言', '10||感谢您的留言', '12');
INSERT INTO `um_sort` VALUES ('100013', '2', ',000000', '行业', '100013', '271', '271', '', '1', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100014', '2', ',000000', '风格', '100014', '271', '271', '', '1', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100015', '2', ',000000', '颜色', '100015', '271', '271', '', '1', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100016', '2', ',000000,100013', '互联网', '100016', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100017', '2', ',000000,100013', '政府', '100017', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100018', '2', ',000000,100013', '学校', '100018', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100019', '2', ',000000,100013', '科技', '100019', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100020', '2', ',000000,100014', '现代', '100020', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100021', '2', ',000000,100014', '民族', '100021', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100022', '2', ',000000,100014', '艳丽', '100022', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100023', '2', ',000000,100014', '简洁', '100023', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100024', '2', ',000000,100015', '红色', 'red', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100025', '2', ',000000,100015', '蓝色', 'blue', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100026', '2', ',000000,100015', '黄色', 'yellow', '271', '271', '', '2', '100', '0', 'photo/index', 'photo_index,photo_content', '', '', '10', '0');
INSERT INTO `um_sort` VALUES ('100027', '6', ',000000', '内容评论', '100027', '0', '0', '', '1', '100', '0', 'extend/index', 'extend_index', '', '', '10||留言成功等待审核', '7');

-- ----------------------------
-- Table structure for um_tags
-- ----------------------------
...
-- Records of um_tags
-- ----------------------------
INSERT INTO `um_tags` VALUES ('1', '为什么', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('2', '搭建', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('3', '网站', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('4', '究竟', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('5', '选择', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('6', '企业', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('7', '作为', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('8', '后台', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('9', '语言', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('10', '越来越', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('11', '使用', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('12', '功能', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('13', '需要', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('14', '更加', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('15', '可以', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('16', '我们', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('17', '其他', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('18', '简单', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('19', '易于', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('20', '希望', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('21', '喜欢', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('22', '以及', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('23', '丰富', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('24', '扩展', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('25', '目标', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('26', '拥有', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('27', '所在', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('28', '一切', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('29', '人员', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('30', '这里', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('31', '地方', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('32', '贡献', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('33', '开发', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('34', '一个', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('35', '一直', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('36', '欢迎', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('37', '加入我们', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('38', '帮助', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('39', '性能', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('40', '卓越', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('41', '所有', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('42', '的方式', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('43', '暴露', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('44', '出来', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('45', '因为', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('46', '框架', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('47', '开发者', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('48', '高性能', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('49', '学习', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('50', '针对', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('51', '直接', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('52', '对象', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('53', '只是', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('54', '为了', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('55', '任意', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('56', '目的', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('57', '编写', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('58', '根据', '', '0', '0', '1439525250');
INSERT INTO `um_tags` VALUES ('59', '优化', '', '0', '0', '1439525250');
