...
<link rel="stylesheet" href="__PUBLICAPP__/css/umcms.css" type="text/css">
...
function changecolor(){
	var ocolor=$.cookie('um_ocolor');
	var ncolor=$.cookie('um_ncolor');
	if(ocolor&&ncolor){
...
jQuery(function() {
	if($.cookie('um_ncolor')&&$.cookie('um_ncolor')!='blue'){
		$.cookie('um_ocolor','blue');
		changecolor();
	}
	$('.change').click(function(){
		var tcolor=$(this).attr('id');
		if($.cookie('um_ncolor')) $.cookie('um_ocolor',$.cookie('um_ncolor'));
		else $.cookie('um_ocolor','blue');
		$.cookie('um_ncolor',tcolor,{expires:7});
		changecolor();
	});
});
//]]>
