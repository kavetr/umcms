...
$(document).ready(function(){
   ...
   $.each($("pre.lang-html,pre.lang-css,pre.lang-js"), function(i,val){  
     var old=$(val).html();  
     $(val).html('<textarea name="text" id="runcode'+i+'"cols="80"rows="10">'+old+'</textarea><br><input type="button" value="运行代码" onClick="runcode(runcode'+i+')" class="um-button">&nbsp;<input type="button" value="保存代码" onClick="savecode(runcode'+i+')" class="um-button">&nbsp;<input type="button" value="复制代码" onClick="copycode(runcode'+i+')" class="um-button">&nbsp;<input type="button" value="剪切代码" onClick="cutcode(runcode'+i+')" class="um-button">&nbsp;<input type="button" value="粘贴代码" onClick="pastecode(runcode'+i+')" class="um-button">');
