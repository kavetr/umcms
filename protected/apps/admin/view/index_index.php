...
function showleftmenu(target,ifd){//左侧菜单
	//$('#menutop').html(menulist[target].title);//当前主菜单标题
	 ...
	 if(!ifd){
		$("#rightfr").attr("src",channels[firstm].pages[0].url); 
...
<td>
  ...
  <tr>    
    <td class="middlel" width="171" align="center" valign="top" id="frmTitle">
          ...
          <div class="menubot"><a target="_blank" href="http://www.umcms.net">{$ver}</a></div>	
    </td>   
    ...
    <td class="middler" width="100%" align="center" valign="top">
        <iframe name="right" id="rightfr" height="100%" width="100%" border="0" frameborder="0" src="{$framurl}"></iframe>
        <div id="loading"></div>
    </td>
  </tr>
 </table>
