...
class controller{
	...
	protected  function success($msg,$url=NULL,$waitSecond=3,$scripts='')
	{
        ...
        echo '<h4 class="modal-title text-primary"> UMcms成功提示</h4>';
	...
	{		
        ...
        echo '<div class="modal-content">';
        echo '<div class="modal-header">';
        echo '<h4 class="modal-title text-danger"> UMcms失败提示</h4>';
	...
	protected  function jump($msg,$urly=NULL,$ymes,$urln=NULL,$nmes,$waitSecond=3)
	{
        ...
        echo '<div class="modal-content">';
        echo '<div class="modal-header">';
        echo '<h4 class="modal-title text-primary"> UMcms提示</h4>';
