...
<div class="list_head_m">
      ...
      <tr>
        <td align="right">表单POST令牌验证：</td>
        <td><?php if($config['TPL']['TOKEN_ON']){ ?> 
        <input type="radio" name="TPL[TOKEN_ON]" value="true" checked="checked" />开启 
        <input type="radio" name="TPL[TOKEN_ON]" value="false" />关闭 
        <?php }else{?> 
        <input type="radio" name="TPL[TOKEN_ON]" value="true" />开启 
        <input type="radio" name="TPL[TOKEN_ON]" value="false" checked="checked" />关闭 
        <?php }?></td>
        <td class="inputhelp">开启TOKEN防御CSRF攻击，开启时请确保‘静态缓存’处于关闭状态</td>
      </tr>
      <tr>
          <td align="right">自定义错误页URL：</td>
          <td><input class="regular-text" type='text' value="{$config['APP']['ERROR_URL']}" name="APP[ERROR_URL]" size="30" /></td>
          <td class="inputhelp">http://开头，所有系统内错误提示将指向设置地址，若想要显示错误提示请留空</td>
      </tr>
      <tr>
        ...
        <tr>
           <td align="right">搜索页每页显示条数：</td>
           <td><input class="regular-text" type='text' value="{$config['serchnum']}" name="serchnum" id="serchnum" size="8" /></td>
           <td></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
             <textarea cols="70" rows="7" name="REWRITE" id="rewrite"><?php
                 ...
                 <textarea id="defrule" style="display:none"><col>/<id>-<page>-<exsort>.html=default/column/content
<col>/<id>-<page>.html=default/column/content
<col>/<id>.html=default/column/content
<col>-<page>-<exsort>/=default/column/index
<col>-<page>/=default/column/index
<col>/=default/column/index
search-<keywords>-<type>-<page>.html=default/index/search
search-<keywords>-<type>.html=default/index/search
search.html=default/index/search
...
map.html=default/index/map</textarea>
          ...
          <td class="inputhelp">
            ...
            4、如果是nginx环境请<a href="http://www.umcms.net/news/content_20.html" target="_blank">查看说明</a>。<br>
            5、系统放在二级目录下规则不会起效。
          </td>
        </tr>
        </table>
       ...
       <li class="tab_con">
        ...
        <tr>
          <td align="right">栏目封面默认宽度X高度：</td>
          <td><input class="regular-text" type='text' value="{$config['sortMaxwidth']}" name="sortMaxwidth" id="sortMaxwidth" size="7"/>&nbsp;X&nbsp;<input class="regular-text" type='text' value="{$config['sortMaxheight']}" name="sortMaxheight" id="sortMaxheight" size="7"/>&nbsp;px</td>
          <td></td>
        </tr>
        <tr>
          <td align="right">图集缩略默认宽度X高度：</td>
          <td><input class="regular-text" type='text' value="{$config['thumbMaxwidth']}" name="thumbMaxwidth" id="thumbMaxwidth" size="7"/>&nbsp;X&nbsp;<input class="regular-text" type='text' value="{$config['thumbMaxheight']}" name="thumbMaxheight" id="thumbMaxheight" size="7"/>&nbsp;px</td>
          <td></td>
        </tr>
        <tr>
          <td align="right">文章封面默认宽度X高度：</td>
          <td><input class="regular-text" type='text' value="{$config['coverMaxwidth']}" name="coverMaxwidth" id="coverMaxwidth" size="7"/>&nbsp;X&nbsp;<input class="regular-text" type='text' value="{$config['coverMaxheight']}" name="coverMaxheight" id="coverMaxheight" size="7"/>&nbsp;px</td>
          <td></td>
        </tr>
        </table>
           </li>
